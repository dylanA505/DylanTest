...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // plus all additional, each showing the addition name, and addition price, and a grand/final total for the burger (base price + all additions)
        ...
        Hamburger hamburger = new Hamburger("Basic", "beef", 4.99, "White");
        hamburger.addHamburgerAddition1("Tomato", 0.99);
        hamburger.addHamburgerAddition2("Lettuce", 0.99);
        hamburger.addHamburgerAddition3("Cheese", 1.49);
        System.out.println("Total Base Burger price is: " + hamburger.customizeHamburger());
        ...
        healthyBurger.addHamburgerAddition1("Egg", 1.49);
        healthyBurger.addHealthyAddition1("Ice-burg", 0.99);
        System.out.println("Total Healthy Burger price is: " + healthyBurger.customizeHamburger());
        ...
        System.out.println("Total Deluxe Burger price is: " + deluxeBurger.customizeHamburger());
        deluxeBurger.addHamburgerAddition1("duck",3.99);
